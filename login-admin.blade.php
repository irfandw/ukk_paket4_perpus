...
.form-control:focus{background:#0f172a;border-color:#ef4444;box-shadow:0 0 0 4px rgba(245,158,11,.15);color:#fff}
...
<div style="width:100%;max-width:420px">
  ...
  <div class="card-auth">
    <div class="badge-role"><i class="bi bi-shield-lock"></i> Area admin</div>
    <h1>Panel kontrol</h1>
    <p class="sub">Kelola koleksi, pengguna, laporan, dan pengaturan sistem.</p>
    ...
    <form method="POST" action="{{ url('/login') }}" novalidate>
      @csrf
      <input type="hidden" name="role_expected" value="admin">
      <div class="mb-3">
